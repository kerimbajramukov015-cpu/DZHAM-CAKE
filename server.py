...
EMAIL_CONFIG = {
    ...
    'smtp_port': 587,
    'sender_email': 'kerim.bayramukov@mail.ru',
    'sender_password': 'g7IQG4oXFVjwXCVa6gOS',
    'manager_email': 'kerimbajramukov015@gmail.com'
}
...
def log():
    ...
    if typ == 'REGISTRATION':
        ...
        print(f"\n\033[91m[ ОТМЕНА ЗАКАЗА {ts} ]\033[0m")
